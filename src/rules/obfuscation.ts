...
export const obfuscationRules: Rule[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      // ZWNJ (U+200C) and ZWJ (U+200D) are legitimate, required characters in Arabic,
      // Persian, and Indic scripts (and emoji sequences). Only flag them when embedded
      // directly within ASCII/Latin alphanumerics (the hidden-instruction / homoglyph
      // smuggling case) to avoid false positives on normal non-Latin text.
